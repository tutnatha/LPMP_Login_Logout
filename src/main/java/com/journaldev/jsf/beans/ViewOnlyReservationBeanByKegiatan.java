...
//        private CustomComponentsHunianHdrBean customComponentsHunianHdrBean = new CustomComponentsHunianHdrBean();
        ...
        @ManagedProperty("#{customComponentsHunianHdrPerKegiatanBean}")
        private CustomComponentsHunianHdrPerKegiatanBean customComponentsHunianHdrPerKegiatanBean = 
                new CustomComponentsHunianHdrPerKegiatanBean(); //source bean juga
                
        FacesContext fc = FacesContext.getCurrentInstance();    //coba pasang disini.
        
        public ViewOnlyReservationBeanByKegiatan() {
		super();    //pakai koq!!!
...
//    }
    ...
    public CustomComponentsHunianHdrPerKegiatanBean getCustomComponentsHunianHdrPerKegiatanBean() {
        return customComponentsHunianHdrPerKegiatanBean;
    }
