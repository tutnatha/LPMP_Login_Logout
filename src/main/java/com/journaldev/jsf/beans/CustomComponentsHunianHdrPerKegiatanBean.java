...
public class CustomComponentsHunianHdrPerKegiatanBean implements Serializable{
    ...
    public CustomComponentsHunianHdrPerKegiatanBean() {
        super();
    ...
    public void init(){
        ...
        getDaftarhunianHdrPerKegiatan(choosedKode);    //@Session atau @View mempengaruhi getter & Setter variable 
    }
    ...
    public List<DaftarhunianHdr> getDaftarhunianHdrPerKegiatan(String kodeKegiatan){
	HttpHeaders headers = getHeaders();
	RestTemplate restTemplate = new RestTemplate();
//	String url = "http://207.148.66.201:8080/user/daftarhunianHdrs2/{no}";
        String url = SERVICE_BASE_URI+"user/daftarhunianHdrs2/{no}";
	...
	ResponseEntity<DaftarhunianHdr[]> responseEntity = 
                ...
                HttpMethod.GET, requestEntity, DaftarhunianHdr[].class, kodeKegiatan);
